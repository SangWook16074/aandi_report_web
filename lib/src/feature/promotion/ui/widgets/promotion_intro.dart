...
class PromotionIntro extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
      ...
      children: [
        ...
        Container(
          ...
          decoration: BoxDecoration(
              color: Color(0xff3B83F6).withAlpha((255 * 0.3).toInt())),
        )
            .animate()
            .fadeIn(duration: 600.ms, delay: 600.ms)
            .moveY(begin: 20, end: 0),
    ...
    return Container(
      ...
      // Removed fixed infinite height to avoid overflow in scrollview,
      // but added minHeight to maintain full-screen feel where appropriate
      constraints:
          BoxConstraints(minHeight: MediaQuery.of(context).size.height),
      decoration: BoxDecoration(
        color: const Color(0xff050505), // 진한 회색 배경
      ),
